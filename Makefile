...
patch-praat:
	...
	perl patch.pl ../makefile "sys/libsys.a GSL/libgsl.a kar/libkar.a FLAC/libFLAC.a mp3/libmp3.a \\" "\t\tscripting/scripting.o scripting/python.o \`python2.5-config --libs\` \\"
