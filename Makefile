...
scripting.o: scripting.c scripting.h
	gcc -g -c scripting.c -o scripting.o `python2.5-config --cflags`

patch-praat:
	perl patch.pl ../makefile "cd artsynth; make" "\tcd scripting; make"
	perl patch.pl ../makefile "artsynth/libartsynth.a" "\t\tscripting/scripting.o \`python2.5-config --libs\` \\"
